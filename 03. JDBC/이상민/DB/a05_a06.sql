...
SELECT * FROM vwstucou where vcouseq =3;
...
SELECT i.name as vstuname,i.registrationnum as vsturnum,i.phonenum as vstupnum, 
        n.name as vcouname,to_char(c.startdate,'yyyy-mm-dd') as vcoustart,to_char(c.enddate,'yyyy-mm-dd') as vcouend,s.status as vstustatus,i.seq as vstuinseq , c.seq as vcouseq
         ,to_char(i.registrationdate,'yyyy-mm-dd') as vstuinrdate, to_char(s.statusdate,'yyyy-mm-dd') as vstustatusdate     
